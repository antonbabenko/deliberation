---
name: "ask-gemini"
description: "Ask Gemini for a single-shot second opinion."
---
<!-- GENERATED by scripts/sync-hosts.js - edit the source under prompts/, AGENTS.md, or examples/, then regenerate. -->

Call the `deliberation` MCP server's `ask-gemini` tool to ask Gemini for a single-shot second opinion.
