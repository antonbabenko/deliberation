---
name: "ask-grok"
description: "Ask Grok (xAI) for a single-shot second opinion."
---
<!-- GENERATED by scripts/sync-hosts.js - edit the source under prompts/, AGENTS.md, or examples/, then regenerate. -->

Call the `deliberation` MCP server's `ask-grok` tool to ask Grok (xAI) for a single-shot second opinion.
